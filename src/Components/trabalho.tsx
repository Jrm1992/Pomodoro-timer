...
export default function Trabalho() {
  ...
  return (
    <div className='flex flex-col mt-4 md:mt-8 lg:mt-12 h-full justify-center items-center'>
      <h3 className='xl:mt-9  font-bold sm:text-5xl lg:text-6xl xl:text-7xl text-4xl text-blue-500'>Work Time!</h3>
      <div className='flex shadow-md shadow-gray-700 bg-gray-800 flex-col justify-center items-center sm:w-[35%] xl:w-[32%] w-[85%] rounded-2xl m-5 h-[200px] sm:h-[2400px] md:h-[260px] xl:h-[340px]'>
        <p className='bg-transparent text-slate-200 mb-10 text-7xl md:text-9xl xl:text-[168px] font-bold'>
